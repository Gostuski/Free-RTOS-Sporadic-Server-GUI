...
public class MainApp extends JFrame{
	...
	private void setHandlers() {
		...
		createButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if(nameTextField.getText().isBlank() || arrivalTextField.getText().isBlank() || periodTextField.getText().isBlank() || periodTextField.getText().isBlank() || durationTextField.getText().isBlank()|| parameterTextField.getText().isBlank() || taskTypeBox.getSelectedIndex() == -1) {
					String text = "Fill in all fields";
					JOptionPane.showMessageDialog(null, text);
					return;
				}
		...
		addToBatchButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if(nameTextField.getText().isBlank() || arrivalTextField.getText().isBlank() || periodTextField.getText().isBlank() || periodTextField.getText().isBlank() || durationTextField.getText().isBlank() || parameterLabel.getText().isBlank() || taskTypeBox.getSelectedIndex() == -1) {
					String text = "Fill in all fields";
					JOptionPane.showMessageDialog(null, text);
					return;
				}
